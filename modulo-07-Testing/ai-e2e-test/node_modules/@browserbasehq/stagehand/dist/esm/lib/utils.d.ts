 ...
 */
export declare function stripModelProvider(modelId: string): string;
/**
...
export declare function hasModelProviderAuth(clientOptions: unknown): boolean;
export declare function getInheritableModelOptions<T extends object>(clientOptions: T | undefined): Partial<T> | undefined;
