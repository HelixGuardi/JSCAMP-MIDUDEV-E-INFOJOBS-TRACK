...
import { isAdaptiveThinkingAnthropicModel, resolveAdaptiveEffort, } from "../llm/anthropicOptions.js";
...
export class AnthropicCUAClient extends AgentClient {
    ...
    async getAction(inputItems, logger) {
        try {
            ...
            const isAdaptiveThinkingModel = isAdaptiveThinkingAnthropicModel(modelBase);
