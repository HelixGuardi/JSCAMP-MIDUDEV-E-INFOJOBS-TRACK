import { applyPredicates, parseXPathSteps, } from "./xpathParser.js";
...
export function resolveXPathFirst(rawXp, options) {
    return resolveXPathAtIndex(rawXp, 0, options);
}
export function resolveXPathAtIndex(rawXp, index, options) {
