 ...
 */
export async function a11yForFrame(session, frameId, opts) {
...
export function decorateRoles(nodes, opts) {
...
export async function buildHierarchicalTree(nodes, opts) {
...
export function extractUrlFromAXNode(ax) {
...
export function removeRedundantStaticTextChildren(parent, children) {
    if (!parent.name)
        return children;
