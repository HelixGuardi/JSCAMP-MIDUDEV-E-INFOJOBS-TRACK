import { UnsupportedAISDKModelProviderError, UnsupportedModelError, UnsupportedModelProviderError, } from "../types/public/sdkErrors.js";
...
export function toAISDKClientOptions(subProvider, clientOptions) {
    if (!clientOptions) {
...
export function getAISDKLanguageModel(subProvider, subModelName, clientOptions, middleware) {
