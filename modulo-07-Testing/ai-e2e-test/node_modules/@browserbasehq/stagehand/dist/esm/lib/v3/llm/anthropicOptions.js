...
export const ANTHROPIC_FABLE_5_FALLBACK_MODEL_ID = "claude-opus-4-8";
...
const ADAPTIVE_THINKING_MODEL_BASES = new Set([
    "claude-opus-4-6",
    "claude-opus-4-7",
    "claude-opus-4-8",
    "claude-sonnet-4-6",
...
const XHIGH_CAPABLE_MODEL_BASES = new Set([
    "claude-opus-4-7",
    "claude-opus-4-8",
    "claude-fable-5",
]);
/** True for Anthropic models that support adaptive thinking. */
export function isAdaptiveThinkingAnthropicModel(modelId) {
    return ADAPTIVE_THINKING_MODEL_BASES.has(stripModelProvider(modelId));
}
export function isAnthropicFable5Model(modelId) {
 ...
 */
export function rejectsForcedToolUse(modelId) {
...
export const DEFAULT_ANTHROPIC_ADAPTIVE_EFFORT = "medium";
/**
 ...
 */
export function resolveAdaptiveEffort(modelId, explicit) {
    const candidate = explicit && VALID_EFFORTS.has(explicit)
        ? explicit
 ...
 */
export function anthropicAdaptiveThinkingOptions(modelId, effort) {
    if (!isAdaptiveThinkingAnthropicModel(modelId))
        return undefined;
 ...
 */
export function anthropicFallbacksOptions(modelId) {
...
//# sourceMappingURL=anthropicOptions.js.map