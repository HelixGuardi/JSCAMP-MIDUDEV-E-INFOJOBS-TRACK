...
import { LoadState, SnapshotResult, PageSnapshotOptions, WebMCPListToolsOptions, WebMCPTool, WebMCPToolInvocation, WebMCPToolInvocationOptions } from "../types/public/page.js";
...
export declare class Page {
    ...
    private webMCPEnablePromise;
    private readonly pendingWebMCPInvocations;
    private readonly bufferedWebMCPResults;
    private pendingWebMCPInvokeToolResponses;
     ...
     */
    private collectWebMCPToolsSnapshot;
    private cleanupWebMCPInvocation;
    private teardownWebMCP;
    targetId(): string;
    /**
    ...
    invokeWebMCPTool(toolName: string, input: Record<string, unknown>, options?: WebMCPToolInvocationOptions): Promise<WebMCPToolInvocation>;
