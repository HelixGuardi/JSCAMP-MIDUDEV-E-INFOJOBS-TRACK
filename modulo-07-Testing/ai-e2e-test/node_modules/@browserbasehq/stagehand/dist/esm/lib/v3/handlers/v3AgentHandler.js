...
import { anthropicAdaptiveThinkingOptions, anthropicFallbacksOptions, } from "../llm/anthropicOptions.js";
...
export class V3AgentHandler {
    ...
    consolidateMetricsAndResult(startTime, state, inputMessages, result, maxSteps, output) {
        ...
        if (result.totalUsage) {
            this.v3.updateMetrics(V3FunctionName.AGENT, result.totalUsage.inputTokens || 0, result.totalUsage.outputTokens || 0, result.totalUsage.reasoningTokens || 0, result.totalUsage.cachedInputTokens || 0, inferenceTimeMs);
        }
        return {
