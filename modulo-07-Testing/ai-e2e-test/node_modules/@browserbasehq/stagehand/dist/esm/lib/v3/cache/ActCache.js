...
import { normalizeUrlForCacheKey, safeGetPageUrl, waitForCachedSelector, } from "./utils.js";
...
export class ActCache {
    ...
    async prepareContext(instruction, page, variables) {
        ...
        const cacheKey = this.buildActCacheKey(sanitizedInstruction, normalizeUrlForCacheKey(pageUrl), variableKeys);
        return {
