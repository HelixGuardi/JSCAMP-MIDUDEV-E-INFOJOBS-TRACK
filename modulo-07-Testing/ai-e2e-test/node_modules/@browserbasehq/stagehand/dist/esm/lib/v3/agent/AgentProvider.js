...
import { UnsupportedModelError, UnsupportedModelProviderError, } from "../types/public/sdkErrors.js";
    ...
    getClient(modelName, clientOptions, userProvidedInstructions, tools) {
        ...
        try {
            switch (type) {
                ...
                case "microsoft":
                    return new MicrosoftCUAClient(type, modelName, userProvidedInstructions, clientOptions);
                default:
                    throw new UnsupportedModelProviderError(["openai", "anthropic", "google", "microsoft"], "Computer Use Agent");
            }
        }
        catch (error) {
