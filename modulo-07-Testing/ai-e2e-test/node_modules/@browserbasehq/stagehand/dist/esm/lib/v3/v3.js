...
let V3 = (() => {
    ...
    return class V3 {
        ...
        resolveLlmClient(model) {
            ...
            const overrideHasCredentials = hasModelProviderAuth(clientOptions) ||
            ...
            if (!hasModelProviderAuth(mergedOptions) &&
        ...
        async prepareAgentExecution(options, instructionOrOptions, agentConfigSignature) {
            ...
            const agentThinkingEffort = options?.model && typeof options.model === "object"
                ...
                : undefined;
            const handler = new V3AgentHandler(this, this.logger, agentLlmClient, resolvedExecutionModel, options?.systemPrompt, tools, resolvedMode, this.isCaptchaAutoSolveEnabled, agentThinkingEffort);
