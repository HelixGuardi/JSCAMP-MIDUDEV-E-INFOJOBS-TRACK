 ...
 */
export function buildFrameContext(page) {
...
export async function tryScopedSnapshot(page, options, context, pierce, sessionToIndex, exclusionIntervalsByFrame) {
    ...
    try {
        ...
        if (looksLikeXPath) {
            ...
            const hit = await resolveFocusFrameAndTail(page, focus, context.parentByFrame, context.rootId);
            targetFrameId = hit.targetFrameId;
            tailSelector = hit.tailXPath || undefined;
            absPrefix = hit.absPrefix;
        }
        else {
            const cssHit = await resolveCssFocusFrameAndTail(page, requestedFocus, context.parentByFrame, context.rootId);
 ...
 */
export async function buildSessionIndexes(page, frames, pierce) {
 ...
 */
export async function computeFramePrefixes(page, context, perFrameMaps, frameIds) {
 ...
 */
export function mergeFramesIntoSnapshot(context, perFrameMaps, perFrameOutlines, absPrefix, iframeHostEncByChild, frameIds) {
