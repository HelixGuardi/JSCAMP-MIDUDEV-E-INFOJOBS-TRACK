...
export class V3CuaAgentHandler {
        ...
        this.agentClient.setActionHandler(async (action) => {
            ...
            try {
                ...
                if (shouldLog && this.evidenceCallback) {
                    await this.emitCuaActionStep(action, inferToolOutput(executionResult ?? { success: true }));
                }
    ...
    async execute(optionsOrInstruction) {
        ...
        this.evidenceCallback = wrapEvidenceCallback(options.callbacks?.onEvidence, this.logger);
