...
exports.OpenAICUAClient = void 0;
...
class OpenAICUAClient extends AgentClient_js_1.AgentClient {
    ...
    constructor(type, modelName, userProvidedInstructions, clientOptions, tools) {
        ...
        this.client = new openai_1.default(this.clientOptions);
        this.tools = tools;
    }
    ...
    async getAction(inputItems, previousResponseId) {
        try {
            ...
            FlowLogger_js_1.FlowLogger.logLlmRequest({
                ...
                model: this.modelName,
                prompt: (0, FlowLogger_js_1.extractLlmCuaPromptSummary)(inputItems),
            });
            ...
            FlowLogger_js_1.FlowLogger.logLlmResponse({
                requestId: llmRequestId,
                model: this.modelName,
                output: (0, FlowLogger_js_1.extractLlmCuaResponseSummary)(response.output),
...
exports.OpenAICUAClient = OpenAICUAClient;
