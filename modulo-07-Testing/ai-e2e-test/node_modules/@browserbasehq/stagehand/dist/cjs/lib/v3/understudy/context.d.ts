...
export declare class V3Context {
    ...
    private readonly _domainPolicySessionListeners;
    ...
    private pageCreationFailures;
    private domainPolicyClosingTargets;
    private domainPolicyClosePromises;
    ...
    private installDomainPolicyHandler;
    private uninstallDomainPolicyHandler;
    private handleDomainPolicyRequestPaused;
    ...
    private closePopupIfBlockedByDomainPolicy;
    private closeTargetAfterDomainPolicyViolation;
    /**
     * Detach handler:
