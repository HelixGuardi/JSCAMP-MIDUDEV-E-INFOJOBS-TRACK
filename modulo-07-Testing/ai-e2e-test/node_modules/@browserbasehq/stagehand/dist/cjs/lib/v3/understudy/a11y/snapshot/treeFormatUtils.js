...
exports.formatTreeLine = formatTreeLine;
exports.injectSubtrees = injectSubtrees;
exports.indentBlock = indentBlock;
exports.diffCombinedTrees = diffCombinedTrees;
exports.cleanText = cleanText;
exports.normaliseSpaces = normaliseSpaces;
/**
...
function formatStateFlags(node) {
    let flags = "";
    if (node.selected)
        flags += " [selected]";
    if (node.checked)
...
//# sourceMappingURL=treeFormatUtils.js.map