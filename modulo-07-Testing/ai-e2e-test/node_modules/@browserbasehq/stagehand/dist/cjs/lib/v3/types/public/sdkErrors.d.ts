...
export declare class StagehandUnsupportedBrowserFeatureError extends StagehandError {
...
export declare class CookieValidationError extends StagehandError {
    constructor(message: string);
}
export declare class CookieSetError extends StagehandError {
    constructor(message: string);
}
...
export declare class StagehandLocatorError extends StagehandError {
...
export declare class CuaModelRequiredError extends StagehandError {
...
export declare class ElementNotVisibleError extends StagehandError {
    constructor(selector: string);
}
export declare class ResponseBodyError extends StagehandError {
    constructor(message: string);
}
export declare class ResponseParseError extends StagehandError {
    constructor(message: string);
}
export declare class TimeoutError extends StagehandError {
    constructor(operation: string, timeoutMs: number);
}
export declare class ActTimeoutError extends TimeoutError {
    constructor(timeoutMs: number);
}
export declare class ExtractTimeoutError extends TimeoutError {
    constructor(timeoutMs: number);
}
export declare class ObserveTimeoutError extends TimeoutError {
    constructor(timeoutMs: number);
}
export declare class PageNotFoundError extends StagehandError {
    constructor(identifier: string);
}
export declare class ConnectionTimeoutError extends StagehandError {
    constructor(message: string);
}
export declare class StreamingCallbacksInNonStreamingModeError extends StagehandError {
    readonly invalidCallbacks: string[];
    constructor(invalidCallbacks: string[]);
}
export declare class AgentAbortError extends StagehandError {
    readonly reason: string;
    constructor(reason?: string);
}
export declare class StagehandClosedError extends StagehandError {
    constructor();
}
export declare class CdpConnectionClosedError extends StagehandError {
    constructor(reason: string);
}
export declare class StagehandSetExtraHTTPHeadersError extends StagehandError {
    readonly failures: string[];
    constructor(failures: string[]);
}
export declare class StagehandSetDomainPolicyError extends StagehandError {
    readonly failures: string[];
    constructor(failures: string[]);
}
