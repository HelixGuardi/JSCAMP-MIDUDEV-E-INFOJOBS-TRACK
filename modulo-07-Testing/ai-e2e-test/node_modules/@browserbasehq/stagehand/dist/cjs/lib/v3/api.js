    ...
    prepareModelConfig(model) {
        ...
        if (typeof model === "string") {
            ...
            const inheritedDefault = provider && provider === this.modelProvider
                ? this.getDefaultModelConfig()
                : undefined;
            const apiKey = (0, utils_js_1.hasModelProviderAuth)(inheritedDefault)
                ? undefined
        ...
        const modelHasCredentials = (0, utils_js_1.hasModelProviderAuth)(model) ||
            Boolean(model.apiKey);
        const defaultConfig = provider && provider === this.modelProvider
            ? this.getDefaultModelConfig()
            : undefined;
        const inheritedDefault = modelHasCredentials
            ? (0, utils_js_1.getInheritableModelOptions)(defaultConfig)
            : defaultConfig;
        const mergedModel = {
            ...(inheritedDefault ?? {}),
            ...model,
        };
        const hasProviderAuth = (0, utils_js_1.hasModelProviderAuth)(mergedModel);
