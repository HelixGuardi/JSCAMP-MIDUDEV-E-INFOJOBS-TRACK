...
exports.AnthropicCUAClient = void 0;
 ...
 */
class AnthropicCUAClient extends AgentClient_js_1.AgentClient {
    apiKey;
    baseURL;
    client;
    lastMessageId;
    ...
    constructor(type, modelName, userProvidedInstructions, clientOptions, tools) {
        ...
        this.client = new sdk_1.default(this.clientOptions);
        this.tools = tools;
    }
    ...
    async executeStep(inputItems, logger) {
        try {
            ...
            if (this.actionHandler && stepActions.length > 0) {
                for (const action of stepActions) {
                    try {
                        ...
                        if (error instanceof sdkErrors_js_1.StagehandClosedError) {
                            throw error;
                        }
                        const errorMessage = error instanceof Error ? error.message : String(error);
                        logger({
            ...
            (0, imageCompression_js_1.compressConversationImages)(nextInputItems);
    ...
    async getAction(inputItems, logger) {
        try {
            ...
            const modelBase = (0, utils_js_1.stripModelProvider)(this.modelName);
            ...
            const isAdaptiveThinkingModel = (0, anthropicOptions_js_1.isAdaptiveThinkingAnthropicModel)(modelBase);
            ...
            if (isAdaptiveThinkingModel) {
                ...
                if (this.thinkingEffort !== "none") {
                    ...
                    outputConfig = {
                        effort: (0, anthropicOptions_js_1.resolveAdaptiveEffort)(modelBase, this.thinkingEffort),
                    };
            ...
            if (this.tools && Object.keys(this.tools).length > 0) {
                const customTools = Object.entries(this.tools).map(([name, tool]) => {
                    ...
                    const jsonSchema = (0, zodCompat_js_1.toJsonSchema)(schema);
                    const inputSchema = {
                        type: "object",
            ...
            FlowLogger_js_1.FlowLogger.logLlmRequest({
                ...
                model: this.modelName,
                prompt: (0, FlowLogger_js_1.extractLlmCuaPromptSummary)(messages),
            });
            ...
            FlowLogger_js_1.FlowLogger.logLlmResponse({
                requestId: llmRequestId,
                model: this.modelName,
                output: (0, FlowLogger_js_1.extractLlmCuaResponseSummary)(response.content),
    ...
    async takeAction(toolUseItems, logger) {
        const toolResults = [];
        logger({
            category: "agent",
            ...
            if (name === "computer") {
                ...
                if (action === "screenshot") {
                    ...
                    return {
                        type: "doubleClick",
                        x: input.x ||
                            (input.coordinate ? input.coordinate[0] : 0),
                        y: input.y ||
                            (input.coordinate ? input.coordinate[1] : 0),
                        ...input,
                    };
                }
...
exports.AnthropicCUAClient = AnthropicCUAClient;
//# sourceMappingURL=AnthropicCUAClient.js.map