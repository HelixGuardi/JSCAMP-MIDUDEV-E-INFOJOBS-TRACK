...
exports.AISdkClient = void 0;
const ai_1 = require("ai");
const uuid_1 = require("uuid");
const LLMClient_js_1 = require("./LLMClient.js");
const anthropicOptions_js_1 = require("./anthropicOptions.js");
    ...
    async createChatCompletion({ options, }) {
                    ...
                    value: JSON.stringify({
                        ...
                        messages: options.messages.map((msg) => ({
                            ...
                            content: Array.isArray(msg.content)
                                ? msg.content.map((c) => "image_url" in c
        ...
        switch (providerName) {
            ...
            case "anthropic":
                providerOptions.anthropic = {
                    ...
                    ...((0, anthropicOptions_js_1.anthropicFallbacksOptions)(this.model.modelId) ?? {}),
                };
                break;
            case "azure":
        ...
        if (options.response_model) {
            ...
            if (needsPromptJsonFallback) {
                const parsedSchema = JSON.stringify((0, zodCompat_js_1.toJsonSchema)(options.response_model.schema));
...
You must respond in JSON format. respond WITH JSON. Do not include any other text, formatting or markdown in your output. Do not include \`\`\` or \`\`\`json in your response. Only the JSON object itself.`,
            ...
            try {
                objectResponse = await (0, ai_1.generateObject)({
                    model: this.model,
        ...
        let textResponse;
        try {
            textResponse = await (0, ai_1.generateText)({
                model: this.model,
                messages: formattedMessages,
...
exports.AISdkClient = AISdkClient;
