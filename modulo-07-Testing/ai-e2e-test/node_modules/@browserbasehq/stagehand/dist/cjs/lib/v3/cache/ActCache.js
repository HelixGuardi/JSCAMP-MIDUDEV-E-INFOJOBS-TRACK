...
class ActCache {
    ...
    async prepareContext(instruction, page, variables) {
        ...
        const cacheKey = this.buildActCacheKey(sanitizedInstruction, (0, utils_js_1.normalizeUrlForCacheKey)(pageUrl), variableKeys);
        return {
