...
var mistralSpeechModelOptions = import_v45.z.object({
  /**
   ...
   */
  refAudio: import_v45.z.string().min(1).optional()
});
...
var mistralSpeechResponseSchema = import_v46.z.object({
  audio_data: import_v46.z.string()
});
