...
declare class GatewayForbiddenError extends GatewayError {
    ...
    constructor({ message, statusCode, cause, ruleId, }?: {
        message?: string;
        statusCode?: number;
        cause?: unknown;
        ruleId?: string;
