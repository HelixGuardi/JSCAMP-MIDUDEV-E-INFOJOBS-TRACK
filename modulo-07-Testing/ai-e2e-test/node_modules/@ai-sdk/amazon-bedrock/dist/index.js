...
var BedrockAdditionalModelResponseFieldsSchema = import_v44.z.object({
  delta: import_v44.z.object({
    stop_sequence: import_v44.z.string().nullish()
  }).nullish()
}).catchall(import_v44.z.unknown());
var BedrockToolUseSchema = import_v44.z.object({
  toolUseId: import_v44.z.string(),
  name: import_v44.z.string(),
  input: import_v44.z.unknown()
});
var BedrockReasoningTextSchema = import_v44.z.object({
  signature: import_v44.z.string().nullish(),
...
var BedrockResponseSchema = import_v44.z.object({
  ...
  output: import_v44.z.object({
    message: import_v44.z.object({
      content: import_v44.z.array(
        import_v44.z.object({
          text: import_v44.z.string().nullish(),
          toolUse: BedrockToolUseSchema.nullish(),
          reasoningContent: import_v44.z.union([
            import_v44.z.object({
  ...
  trace: import_v44.z.unknown().nullish(),
...
var BedrockStreamSchema = import_v44.z.object({
  contentBlockDelta: import_v44.z.object({
    contentBlockIndex: import_v44.z.number(),
    delta: import_v44.z.union([
      import_v44.z.object({ text: import_v44.z.string() }),
      import_v44.z.object({ toolUse: import_v44.z.object({ input: import_v44.z.string() }) }),
      import_v44.z.object({
        reasoningContent: import_v44.z.object({ text: import_v44.z.string() })
      }),
      import_v44.z.object({
        reasoningContent: import_v44.z.object({
  ...
  contentBlockStart: import_v44.z.object({
    contentBlockIndex: import_v44.z.number(),
    start: import_v44.z.object({
      toolUse: BedrockToolUseSchema.nullish()
    }).nullish()
  }).nullish(),
  contentBlockStop: import_v44.z.object({
    contentBlockIndex: import_v44.z.number()
  }).nullish(),
  internalServerException: import_v44.z.record(import_v44.z.string(), import_v44.z.unknown()).nullish(),
  messageStop: import_v44.z.object({
    additionalModelResponseFields: BedrockAdditionalModelResponseFieldsSchema.nullish(),
    stopReason: BedrockStopReasonSchema
  }).nullish(),
...
var bedrockEmbeddingProviderOptions = import_v45.z.object({
  /**
  The number of dimensions the resulting output embeddings should have (defaults to 1024).
  Only supported in amazon.titan-embed-text-v2:0.
     */
  dimensions: import_v45.z.union([import_v45.z.literal(1024), import_v45.z.literal(512), import_v45.z.literal(256)]).optional(),
  /**
  Flag indicating whether or not to normalize the output embeddings. Defaults to true
  Only supported in amazon.titan-embed-text-v2:0.
   */
  normalize: import_v45.z.boolean().optional()
});
...
var BedrockEmbeddingResponseSchema = import_v46.z.object({
  embedding: import_v46.z.array(import_v46.z.number()),
  inputTextTokenCount: import_v46.z.number()
});
...
var bedrockImageResponseSchema = import_v47.z.object({
